...
def get_videomaeModel(modelStyle="B"):
    ...
    if(modelStyle == 'S'):
        ...
        path = './auth/_store/_weights/videomae_small_kinetics.pth'

    if(modelStyle == 'B'):
        model = vit_base_patch16_224()
        path = './auth/_store/_weights/videomae_base_kinetics.pth'

    if(modelStyle == 'L'):
        model = vit_large_patch16_224()
        path = './auth/_store/_weights/videomae_large_kinetics.pth'
        
    if(modelStyle == 'G'):
        model =  vit_huge_patch16_224()
        path = './auth/_store/_weights/videomae_huge_kinetics.pth'
...
class videomae(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.dense_id = torch.nn.Linear(in_features=self.output_dim,out_features=self.I)
